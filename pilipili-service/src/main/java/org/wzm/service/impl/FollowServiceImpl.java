...
public class FollowServiceImpl implements FollowService {
    ...
    @Override
    public PageResult<UserFollowing> listFansByPage(int pageIndex, int pageSize) {
        List<UserFollowing> page = userFollowingMapper.page(pageIndex, pageSize);
        PageResult<UserFollowing> result = new PageResult<>();
        result.setList(page);
